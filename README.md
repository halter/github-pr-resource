...
|-----------------------------|----------|----------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `repository`                | Yes*     | `itsdalmo/test-repository`       | The GitHub repository to target. Required unless `gitea_repository` is set.                                                                                                                                                                                                                |
...
| `gitea_repository`          | No       | `itsdalmo/test-repository`       | A Gitea repository to target. When set together with `repository`, pull requests from both GitHub and Gitea are interleaved into the same version stream.                                                                                                                                  |
| `gitea_endpoint`            | No       | `https://gitea.example.com`      | Base URL of the Gitea instance. Required when `gitea_repository` is set.                                                                                                                                                                                                                   |
| `gitea_access_token`        | No       |                                  | A Gitea access token with repository access. Required when `gitea_repository` is set.                                                                                                                                                                                                     |
...
- `provider`: Set to `gitea` for pull requests from the configured Gitea repository. Omitted for GitHub.
